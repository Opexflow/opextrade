...
class DemoComp extends Component {
  constructor(props) {
      ...
      this.state = {
          ...
          currentTicks:  window?.localStorage.getItem('ticks') || '5min.json',
      };
  ...
  getHost(postfix) {
      ...
      let host = `http://${window?.location.host}/${postfix}`;
  ...
  getChartData() {
      ...
      if (this.state.loadedData) {
          ...
          console.log(this.loadedData[this.state.currentTicks]);
      ...
      */
      ...
      x.open('GET', this.getHost(this.state.currentTicks), true);
      x.onload = () => {
